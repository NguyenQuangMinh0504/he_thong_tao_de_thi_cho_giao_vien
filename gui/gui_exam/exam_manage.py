...
from gui.gui_exam.tao_de_thi_pop_up import Ui_tao_de_thi_pop_up
...
"border-color: grey;}")
        ...
        for i, exam_info in enumerate(get_exam(self.subject_id)):
            ...
            self.de_thi_button.setStyleSheet("background-image : url(./gui/gui_exam/canvas_background.jpeg);")
